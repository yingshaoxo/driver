...
const float left_bias = 0.02;//.02634375;
const float right_bias = 0;//0.01234375;
    ...
    if ((A == 1) && (B == 1) && (C == 1)) {
        if (back_times < 3) {
            if (last_action == 0) {
                ...
                delayMicroseconds(random(1, 10000));
            } else if (last_action == 1) {
